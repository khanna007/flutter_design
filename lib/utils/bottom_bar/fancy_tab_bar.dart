...
class FancyTabBar extends StatefulWidget {
  ...
  @override
  FancyTabBarStateNew createState() => FancyTabBarStateNew();
}

class FancyTabBarStateNew extends State<FancyTabBar>
    ...
    return Stack(
      ...
      children: <Widget>[
        Container(
          ...
          decoration:const BoxDecoration(color:  Color(0xffAE9173), boxShadow: [
            BoxShadow(
            ...
            children: <Widget>[
              ...
              TabItem(
                  ...
                  callbackFunction: () {
                    ...
                    _initAnimationAndStart(_positionAnimation.value, 0.05);
                  }),
              TabItem(
                  ...
                  callbackFunction: () {
                    ...
                    _initAnimationAndStart(_positionAnimation.value, 0.7);
                  }),
              TabItem(
                  ...
                  callbackFunction: () {
                    setState(() {
                      nextIcon = Icons.ac_unit;
                      currentSelected = 3;
                    });
                    _initAnimationAndStart(_positionAnimation.value, 1.3);
                  })
            ],
          ),
        ),
